...
import com.xb.toolkit.ui.activity.XPermissionActivity;
...
public class PermissionsUtil {
    ...
    private static HashMap<String, IXPermissionListener> listenerMap = new HashMap();
     ...
     */
    public static void requestPermission(Context context, IXPermissionListener listener, String... permission) {
     ...
     */
    public static void requestPermission(@NonNull Context context, @NonNull IXPermissionListener listener
     ...
     * @return
     */
    public static IXPermissionListener fetchListener(String key) {
