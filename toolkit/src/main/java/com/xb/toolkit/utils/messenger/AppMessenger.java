package com.xb.toolkit.utils.messenger;
...
public class AppMessenger {
    private static AppMessenger defaultInstance;
    ...
    public static AppMessenger getDefault() {
        if (defaultInstance == null) {
            defaultInstance = new AppMessenger();
        }
        return defaultInstance;
    }


    public static void overrideDefault(AppMessenger newMessenger) {
    ...
    /**
     * @param recipient {@link cc.iwumei.lib.tools.messenger.AppMessenger#register(Object, Action0)}
    ...
    /**
     * see {@link cc.iwumei.lib.tools.messenger.AppMessenger#register(Object, Class, Action1)}
     *
    ...
    /**
     * see {@link cc.iwumei.lib.tools.messenger.AppMessenger#register(Object, Object, Action0)}
     *
     * @param recipient receiver of message
     * @param token     register with a unique token,when a messenger send a msg with same token,it will receive this msg
    ...
    /**
     * see {@link cc.iwumei.lib.tools.messenger.AppMessenger#register(Object, Object, Class, Action1)}
     *
     * @param recipient                 receiver of message
     * @param token                     register with a unique token,when a messenger send a msg with same token,it will receive this msg
     * @param receiveDerivedMessagesToo whether derived class of recipient can receive the message
