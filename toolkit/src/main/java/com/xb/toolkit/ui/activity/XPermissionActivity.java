...
public class XPermissionActivity extends AppCompatActivity {
    ...
    private void showMissingPermissionDialog() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(XPermissionActivity.this);
        ...
        builder.setPositiveButton(TextUtils.isEmpty(tipInfo.ensure) ? defaultEnsure : tipInfo.ensure, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                PermissionsUtil.gotoSetting(XPermissionActivity.this);
            }
        });
    ...
    private void permissionsDenied() {
        IXPermissionListener listener = PermissionsUtil.fetchListener(key);
        if (listener != null) {
