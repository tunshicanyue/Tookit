...
/**
 * Created by zhangbw(biaoweizh@gmail.com) on 2017/12/25.
 * Description:带清除功能的edittextview
 */
...
public class ClearEditTextView extends AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    ...
    private void init() {
        ...
        mSearchDrawble = getResources().getDrawable(R.drawable.ic_search_black_24dp);
        //设置删除按钮的边界
        mSearchDrawble.setBounds(0, 0, mSearchDrawble.getIntrinsicWidth(), mSearchDrawble.getIntrinsicHeight());
        //默认显示搜索按钮
        setSearchIcon(true);
    ...
    public void setSearchIcon(boolean isShow) {
        Drawable leftDrawable = isShow ? mSearchDrawble : null;
